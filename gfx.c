...
BNX_BOOL gfxInit()
{
	...
	_Gfx.screen = SDL_SetVideoMode( 640, 480, cGfxColorDepth, SDL_FULLSCREEN );
	if ( _Gfx.screen == 0 )
	{
		return BNX_FALSE;
	}
...
void gfxPrintTextWave( BNX_INT16 x, BNX_INT16 y, const char *text, BNX_INT16 start )
{
	char		c;
	SDL_Rect	tpos, ppos;
	BNX_INT16	sinuz[] = { 0, 1, 2, 3, 4, 3, 2, 1, 0, -1, -2, -3, -4, -3, -2, -1 };
...
BNX_BOOL gfxLoadResources()
{
	...
	SDL_SetAlpha( _Gfx.movecount, SDL_SRCALPHA | SDL_RLEACCEL, cGfxWinBlending );
	SDL_SetAlpha( _Gfx.markers[0], SDL_SRCALPHA | SDL_RLEACCEL, cGfxWinBlending );
	SDL_SetAlpha( _Gfx.markers[1], SDL_SRCALPHA | SDL_RLEACCEL, cGfxWinBlending );
	SDL_SetAlpha( _Gfx.elements[0], SDL_SRCALPHA | SDL_RLEACCEL, 210 );
	SDL_SetAlpha( _Gfx.elements[1], SDL_SRCALPHA | SDL_RLEACCEL, 210 );
	SDL_SetAlpha( _Gfx.elements[2], SDL_SRCALPHA | SDL_RLEACCEL, 210 );
	SDL_SetAlpha( _Gfx.elements[3], SDL_SRCALPHA | SDL_RLEACCEL, 210 );
